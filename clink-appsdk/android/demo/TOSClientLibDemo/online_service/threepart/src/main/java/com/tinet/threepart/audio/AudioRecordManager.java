...
public class AudioRecordManager implements Handler.Callback {
     ...
     * 滑动取消
     */
    private static final int STATUS_WILL_CANCEL = 3;

    /**
     * 继续录制
     */
    private static final int STATUS_CONTINUE = 4;
    ...
    public boolean isRecording() {
        return this.mCurAudioState instanceof RecordState;
    }
...
//                int bps = e.getInteger(e.getIdentifier("rc_audio_encoding_bit_rate", "integer", this.mContext.getPackageName()));
            ...
            this.mAudioPath = Uri.fromFile(new File(SAVE_PATH, System.currentTimeMillis() + "tinet.wav"));
