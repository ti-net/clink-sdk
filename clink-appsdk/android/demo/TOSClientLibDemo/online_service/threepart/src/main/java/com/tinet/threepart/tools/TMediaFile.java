 ...
 * @ClassName: MediaFile
 * @Author: zhangping
 * @CreateDate: 2020/7/20 15:57
 * @Description: 描述说明
 */
public class TMediaFile {
    ...
    public static boolean isImage(String uri) {
        String ext = MIMEUtils.getFileExtension(uri);

        return BMP.equalsIgnoreCase(ext) || GIF.equalsIgnoreCase(ext) || JPEG.equalsIgnoreCase(ext) || JPG.equalsIgnoreCase(ext) || PNG.equalsIgnoreCase(ext);
    }
