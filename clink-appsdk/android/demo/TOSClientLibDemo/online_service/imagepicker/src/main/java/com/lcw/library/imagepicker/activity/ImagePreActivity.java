...
public class ImagePreActivity extends BaseActivity {
    ...
    private void updateSelectButton(String imagePath) {
        ...
        if (isSelect) {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.drawable.ti_ic_image_checked));
        } else {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.drawable.ti_ic_image_check));
        }
    }
