    ...
    private void bindMedia(MediaHolder mediaHolder, MediaFile mediaFile) {
        ...
        if (!TextUtils.isEmpty(imagePath)) {
            ...
            if (SelectionManager.getInstance().isImageSelect(imagePath)) {
                ...
                mediaHolder.mImageCheck.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ti_ic_image_checked));
            } else {
                mediaHolder.mImageView.setColorFilter(null);
                mediaHolder.mImageCheck.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ti_ic_image_check));
            }
