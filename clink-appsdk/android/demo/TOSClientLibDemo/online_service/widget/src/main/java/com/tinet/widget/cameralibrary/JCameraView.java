package com.tinet.widget.cameralibrary;
...
import com.tinet.widget.R;
import com.tinet.widget.cameralibrary.listener.CaptureListener;
import com.tinet.widget.cameralibrary.listener.ClickListener;
import com.tinet.widget.cameralibrary.listener.ErrorListener;
import com.tinet.widget.cameralibrary.listener.JCameraListener;
import com.tinet.widget.cameralibrary.listener.TypeListener;
import com.tinet.widget.cameralibrary.state.CameraMachine;
import com.tinet.widget.cameralibrary.util.FileUtil;
import com.tinet.widget.cameralibrary.util.ScreenUtils;
import com.tinet.widget.cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconSize = a.getDimensionPixelSize(R.styleable.JCameraView_tinetIconSize, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 35, getResources().getDisplayMetrics()));
        iconMargin = a.getDimensionPixelSize(R.styleable.JCameraView_tinetIconMargin, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics()));
        iconSrc = a.getResourceId(R.styleable.JCameraView_tinetIconSrc, R.drawable.ic_camera);
        iconLeft = a.getResourceId(R.styleable.JCameraView_tinetIconLeft, 0);
        iconRight = a.getResourceId(R.styleable.JCameraView_tinetIconRight, R.mipmap.ti_capture);
        duration = a.getInteger(R.styleable.JCameraView_tinetDurationMax, 10 * 1000);       //没设置默认为10s
        a.recycle();
        initData();
        initView();
    }
