...
import com.tinet.widget.cameralibrary.util.AngleUtil;
import com.tinet.widget.cameralibrary.util.CameraParamUtil;
import com.tinet.widget.cameralibrary.util.CheckPermission;
import com.tinet.widget.cameralibrary.util.DeviceUtil;
        ...
        if (mCamera != null) {
            try {
                ...
                Camera.Size previewSize = CameraParamUtil.getInstance().getPreviewSize(mParams
                        .getSupportedPreviewSizes(), PreviewHeight, screenProp);
                Camera.Size pictureSize = CameraParamUtil.getInstance().getPictureSize(mParams
                        .getSupportedPictureSizes(), PreviewWidth, screenProp);
