...
import com.tinet.widget.cameralibrary.listener.ReturnListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private TextView iv_custom_left;            //左边自定义按钮
    ...
    private void initView() {
        ...
        //拍照按钮
        btn_capture = new CaptureButton(getContext().getApplicationContext(), button_size);
...
//                resetCaptureLayout();
        ...
        //返回按钮
        btn_return = new TextView(getContext());
        ...
        btn_return.setText("取消");
        btn_return.setTextSize(COMPLEX_UNIT_SP,13);
        btn_return.setTextColor(0xFFFFFFFF);
        ...
        //左边自定义按钮
        iv_custom_left = new TextView(getContext());
        ...
        LayoutParams iv_custom_param_right = new LayoutParams((int) (button_size / 3.5f), (int) (button_size / 3.5f));
        ...
        txt_param.setMargins(0, 0, 0, 32);
        txt_tip.setText("点击拍照，长按摄像");
        txt_tip.setTextSize(COMPLEX_UNIT_SP,12);
