...
#import "TRCustomSearchBar.h"

@interface TRCustomSearchBar () <UITextFieldDelegate>
...
static CGFloat const placeHolderFont = 13.f;

@implementation TRCustomSearchBar
- (void)layoutSubviews {
    [super layoutSubviews];
    
    self.backgroundImage = [UIImage cacheImageOriginalType:@"customer_searchBox"];
