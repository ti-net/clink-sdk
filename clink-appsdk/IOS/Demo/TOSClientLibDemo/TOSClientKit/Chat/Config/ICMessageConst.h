...
extern NSString *const RouterEventGetSendTextMessageRobotFormIntents;
...
extern NSString *const TinetRouterClickEventRobotFormIntents;
...
extern NSString *const TinetRouterBeSendCommodityCardEventUrl;
