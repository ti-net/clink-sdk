...
{
    NSString *path = [[NSSearchPathForDirectoriesInDomains(NSCachesDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"Chat/Video"];
    NSString * videoPath = [path stringByAppendingPathComponent:[NSString stringWithFormat:@"%@",filePath.lastPathComponent]];
    AVURLAsset *asset = [AVURLAsset URLAssetWithURL:[[NSURL alloc] initFileURLWithPath:videoPath] options:nil];
