...
@interface TIMVideoBrowseActionSlider : UISlider
@end
@implementation TIMVideoBrowseActionSlider
...
@property (nonatomic, strong) TIMVideoBrowseActionSlider *slider;
@end
...
- (TIMVideoBrowseActionSlider *)slider {
    if (!_slider) {
        _slider = [TIMVideoBrowseActionSlider new];
