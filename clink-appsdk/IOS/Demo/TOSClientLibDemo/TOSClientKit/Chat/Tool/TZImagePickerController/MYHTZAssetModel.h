...
typedef enum : NSUInteger {
    MYHTZAssetModelMediaTypePhoto = 0,
    MYHTZAssetModelMediaTypeLivePhoto,
    MYHTZAssetModelMediaTypePhotoGif,
    MYHTZAssetModelMediaTypeVideo,
    MYHTZAssetModelMediaTypeAudio
} MYHTZAssetModelMediaType;

@class PHAsset;
@interface MYHTZAssetModel : NSObject

@property (nonatomic, strong) PHAsset *asset;
@property (nonatomic, assign) BOOL isSelected;      ///< The select status of a photo, default is No
@property (nonatomic, assign) MYHTZAssetModelMediaType type;
...
@class PHFetchResult;
@interface MYHTZAlbumModel : NSObject
