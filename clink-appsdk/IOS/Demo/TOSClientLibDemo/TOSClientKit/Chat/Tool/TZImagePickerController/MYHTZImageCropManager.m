...
@implementation MYHTZImageCropManager
...
+ (UIImage *)cropImageView:(UIImageView *)imageView toRect:(CGRect)rect zoomScale:(double)zoomScale containerView:(UIView *)containerView {
    ...
    CGFloat xMargin = containerView.tos_tz_width - CGRectGetMaxX(rect) - rect.origin.x;
    ...
    cropedImage = [[MYHTZImageManager manager] fixOrientation:cropedImage];
