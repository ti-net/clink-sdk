...
/// 获取UA
+ (NSString *)sl_getUserAgentWithString:(NSString *)customUserAgent {
    //获取UserAgent 这个是异步的
...
//    NSString *userAgent = [webView stringByEvaluatingJavaScriptFromString:@"navigator.userAgent"];
    ...
    [wkWebView evaluateJavaScript:@"navigator.userAgent" completionHandler:^(id _Nullable result, NSError * _Nullable error) {
        ...
        NSString *appUserAgent = [NSString stringWithFormat:@"%@-%@", oldUA, customUserAgent];
...
+ (void)sl_setCustomUserAgentWithType:(SLSetUAType)type UAString:(NSString *)customUserAgent {
    ...
    if (type == SLSetUATypeReplace) {
        ...
        [WKWebView sl_getUserAgentWithString:customUserAgent];
