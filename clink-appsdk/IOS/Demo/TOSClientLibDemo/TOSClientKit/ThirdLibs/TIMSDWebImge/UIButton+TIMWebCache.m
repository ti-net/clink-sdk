...
@implementation UIButton (TIMWebCache)
...
- (void)sd_setImageLoadOperation:(id<TIMSDWebImageOperation>)operation forState:(UIControlState)state {
...
- (void)sd_setBackgroundImageLoadOperation:(id<TIMSDWebImageOperation>)operation forState:(UIControlState)state {
