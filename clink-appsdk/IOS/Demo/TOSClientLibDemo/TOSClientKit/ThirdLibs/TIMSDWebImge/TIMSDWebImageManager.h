...
typedef void(^SDWebImageCompletionBlock)(UIImage *image, NSError *error, TIMSDImageCacheType cacheType, NSURL *imageURL);

typedef void(^SDWebImageCompletionWithFinishedBlock)(UIImage *image, NSError *error, TIMSDImageCacheType cacheType, BOOL finished, NSURL *imageURL);
...
TIMSDWebImageManager *manager = [TIMSDWebImageManager sharedManager];
[manager downloadWithURL:imageURL
                 options:0
                progress:nil
               completed:^(UIImage *image, NSError *error, TIMSDImageCacheType cacheType, BOOL finished, NSURL *imageURL) {
                   if (image) {
...
[[TIMSDWebImageManager sharedManager] setCacheKeyFilter:^(NSURL *url) {
 ...
 */
+ (TIMSDWebImageManager *)sharedManager;
