...
typedef NS_ENUM(NSInteger, TIMSDImageCacheType) {
    /**
     * The image wasn't available the SDWebImage caches, but was downloaded from the web.
     */
    TIMSDImageCacheTypeNone,
    /**
     * The image was obtained from the disk cache.
     */
    TIMSDImageCacheTypeDisk,
    /**
     * The image was obtained from the memory cache.
     */
    TIMSDImageCacheTypeMemory
};

typedef void(^SDWebImageQueryCompletedBlock)(UIImage *image, TIMSDImageCacheType cacheType);
 ...
 */
@interface TIMSDImageCache : NSObject
