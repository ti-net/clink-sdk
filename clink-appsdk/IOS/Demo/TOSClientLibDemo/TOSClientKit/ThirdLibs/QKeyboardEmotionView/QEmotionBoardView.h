...
@class QEmotionBoardView;

@protocol QEmotionBoardViewDelegate <NSObject>
 ...
 */
@interface QEmotionBoardView : UIView
...
@property(nonatomic, weak) id<QEmotionBoardViewDelegate> delegate;
