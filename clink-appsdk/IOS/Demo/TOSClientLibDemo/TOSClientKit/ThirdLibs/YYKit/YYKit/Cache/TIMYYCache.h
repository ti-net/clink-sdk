...
@class TIMYYMemoryCache, TIMYYDiskCache;
...
/**
 ...
 It use `TIMYYMemoryCache` to store objects in a small and fast memory cache,
 and use `YYDiskCache` to persisting objects to a large and slow disk cache.
 See `TIMYYMemoryCache` and `YYDiskCache` for more information.
 */
@interface TIMYYCache : NSObject

/** The name of the cache, readonly. */
@property (copy, readonly) NSString *name;

/** The underlying memory cache. see `TIMYYMemoryCache` for more information.*/
@property (strong, readonly) TIMYYMemoryCache *memoryCache;

/** The underlying disk cache. see `YYDiskCache` for more information.*/
@property (strong, readonly) TIMYYDiskCache *diskCache;
