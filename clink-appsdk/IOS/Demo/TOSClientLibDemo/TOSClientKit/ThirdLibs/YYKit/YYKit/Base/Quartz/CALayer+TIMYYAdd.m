...
@implementation CALayer (TIMYYAdd)

- (UIImage *)snapshotImage {
    if (self.bounds.size.width <= 0 || self.bounds.size.height <= 0 || isnan(self.bounds.size.width) || isnan(self.bounds.size.height)) return nil;
