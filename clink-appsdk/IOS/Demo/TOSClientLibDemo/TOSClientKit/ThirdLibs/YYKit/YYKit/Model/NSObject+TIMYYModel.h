 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `TIMYYModel` protocol for custom methods.
 ...
 */
@interface NSDictionary (TIMYYModel)
...
/**
 ...
 There's no need to add '<TIMYYModel>' to your class header.
 */
@protocol TIMYYModel <NSObject>
@optional
