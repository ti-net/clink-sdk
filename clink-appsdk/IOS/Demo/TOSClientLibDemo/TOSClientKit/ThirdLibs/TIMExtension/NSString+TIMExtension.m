...
@implementation NSString (TIMExtension)
...
@implementation NSString (TIMExtensionDeprecated_v_2_5_16)
- (NSString *)underlineFromCamel
{
    return self.mjtim_underlineFromCamel;
}

- (NSString *)camelFromUnderline
{
    return self.mjtim_camelFromUnderline;
}

- (NSString *)firstCharLower
{
    return self.mjtim_firstCharLower;
}

- (NSString *)firstCharUpper
{
    return self.mjtim_firstCharUpper;
}

- (BOOL)isPureInt
{
    return self.mjtim_isPureInt;
}

- (NSURL *)url
{
    return self.mjtim_url;
}
@end
