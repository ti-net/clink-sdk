...
@implementation UITextView (TIMQEmotion)
...
- (NSString *)normalText {
    ...
    [self.attributedText enumerateAttribute:NSAttachmentAttributeName
        ...
        if ([value isKindOfClass:[TIMQEmotionAttachment class]]) {
            TIMQEmotionAttachment *valueAttachment = (TIMQEmotionAttachment *)value;
