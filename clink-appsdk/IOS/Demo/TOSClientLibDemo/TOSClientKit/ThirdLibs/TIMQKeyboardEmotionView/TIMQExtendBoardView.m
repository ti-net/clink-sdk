...
@implementation TIMQExtendBoardItemModel
...
@interface TIMQExtendBoardView () <UIScrollViewDelegate>
...
@implementation TIMQExtendBoardView
...
- (void)reloadData {
    ...
    CGFloat paddingX = 10;
    CGFloat paddingY = 10;
    for (TIMQExtendBoardItemModel *extendItem in self.extendBoardItems) {
