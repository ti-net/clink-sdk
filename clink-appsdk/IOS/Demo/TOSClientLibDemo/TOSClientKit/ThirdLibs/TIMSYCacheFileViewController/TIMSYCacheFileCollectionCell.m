//
//  TIMSYCacheFileCollectionCell.m
//  zhangshaoyu
//
...
@interface TIMSYCacheFileCollectionCell ()
...
@implementation TIMSYCacheFileCollectionCell
...
- (void)setUI
{
    _backView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, widthCollectionViewCell, timheightCollectionViewCell)];
