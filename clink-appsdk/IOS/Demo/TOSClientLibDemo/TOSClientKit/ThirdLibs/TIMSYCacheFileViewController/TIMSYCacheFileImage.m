...
@interface TIMSYCacheScaleImage () <UIScrollViewDelegate>

@property (nonatomic, strong) UIImageView *imageView;

@end

@implementation TIMSYCacheScaleImage
...
@interface TIMSYCacheFileImage () <UIScrollViewDelegate>
...
@implementation TIMSYCacheFileImage
...
- (void)reloadImages
{
    if (self.images && self.images.count > 0) {
        ...
        //
        TIMSYCacheFileImage __weak *weakSelf = self;
        [self.images enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            TIMSYCacheScaleImage *imageView = [[TIMSYCacheScaleImage alloc] initWithFrame:rect];
