...
@interface TOSAutoLayoutModel ()

@property (nonatomic, strong) TOSAutoLayoutModelItem *width;
@property (nonatomic, strong) TOSAutoLayoutModelItem *height;
@property (nonatomic, strong) TOSAutoLayoutModelItem *left;
@property (nonatomic, strong) TOSAutoLayoutModelItem *top;
@property (nonatomic, strong) TOSAutoLayoutModelItem *right;
@property (nonatomic, strong) TOSAutoLayoutModelItem *bottom;
...
@property (nonatomic, strong) TOSAutoLayoutModelItem *ratio_width;
@property (nonatomic, strong) TOSAutoLayoutModelItem *ratio_height;
@property (nonatomic, strong) TOSAutoLayoutModelItem *ratio_left;
@property (nonatomic, strong) TOSAutoLayoutModelItem *ratio_top;
@property (nonatomic, strong) TOSAutoLayoutModelItem *ratio_right;
@property (nonatomic, strong) TOSAutoLayoutModelItem *ratio_bottom;

@property (nonatomic, strong) TOSAutoLayoutModelItem *equalLeft;
@property (nonatomic, strong) TOSAutoLayoutModelItem *equalRight;
@property (nonatomic, strong) TOSAutoLayoutModelItem *equalTop;
@property (nonatomic, strong) TOSAutoLayoutModelItem *equalBottom;
@property (nonatomic, strong) TOSAutoLayoutModelItem *equalCenterX;
@property (nonatomic, strong) TOSAutoLayoutModelItem *equalCenterY;

@property (nonatomic, strong) TOSAutoLayoutModelItem *widthEqualHeight;
@property (nonatomic, strong) TOSAutoLayoutModelItem *heightEqualWidth;

@property (nonatomic, strong) TOSAutoLayoutModelItem *lastModelItem;

@end

@implementation TOSAutoLayoutModel
...
- (TOSMarginToView)marginToViewblockWithKey:(NSString *)key
{
    ...
    return ^(id viewOrViewsArray, CGFloat value) {
        TOSAutoLayoutModelItem *item = [TOSAutoLayoutModelItem new];
        item.value = @(value);
...
- (TOSWidthHeight)widthIs
{
    if (!_widthIs) {
        ...
        _widthIs = ^(CGFloat value) {
            ...
            TOSAutoLayoutModelItem *widthItem = [TOSAutoLayoutModelItem new];
...
- (TOSWidthHeight)heightIs
{
    if (!_heightIs) {
        ...
        _heightIs = ^(CGFloat value) {
            ...
            TOSAutoLayoutModelItem *heightItem = [TOSAutoLayoutModelItem new];
...
- (TOSWidthHeightEqualToView)widthRatioToView
{
    if (!_widthRatioToView) {
        ...
        _widthRatioToView = ^(UIView *view, CGFloat value) {
            weakSelf.ratio_width = [TOSAutoLayoutModelItem new];
...
- (TOSWidthHeightEqualToView)heightRatioToView
{
    if (!_heightRatioToView) {
        ...
        _heightRatioToView = ^(UIView *view, CGFloat value) {
            weakSelf.ratio_height = [TOSAutoLayoutModelItem new];
...
- (TOSSameWidthHeight)widthEqualToHeight
{
    ...
    if (!_widthEqualToHeight) {
        _widthEqualToHeight = ^() {
            weakSelf.widthEqualHeight = [TOSAutoLayoutModelItem new];
...
- (TOSSameWidthHeight)heightEqualToWidth
{
    ...
    if (!_heightEqualToWidth) {
        _heightEqualToWidth = ^() {
            weakSelf.heightEqualWidth = [TOSAutoLayoutModelItem new];
...
- (TOSAutoLayoutModel *(^)(CGFloat))offset
{
    __weak typeof(self) weakSelf = self;
    if (!_offset) {
...
@implementation UIView (TIMAutoHeightWidth)

- (TIMUIViewCategoryManager *)sd_categoryManager
{
    TIMUIViewCategoryManager *manager = objc_getAssociatedObject(self, _cmd);
    if (!manager) {
        objc_setAssociatedObject(self, _cmd, [TIMUIViewCategoryManager new], OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
...
@implementation UIView (TIMLayoutExtention)
...
@implementation UIView (TIMAutoFlowItems)
...
@implementation UIScrollView (TIMAutoContentSize)
...
@implementation UILabel (TIMLabelAutoResize)
...
@implementation UIButton (TIMExtention)
...
@implementation TOSAutoLayoutModelItem
...
@implementation UIView (TOSAutoLayout)
...
- (TOSAutoLayoutModel *)ownLayoutModel
{
    return objc_getAssociatedObject(self, _cmd);
}

- (void)setOwnLayoutModel:(TOSAutoLayoutModel *)ownLayoutModel
{
    objc_setAssociatedObject(self, @selector(ownLayoutModel), ownLayoutModel, OBJC_ASSOCIATION_RETAIN);
}

- (TOSAutoLayoutModel *)sd_layout
{
...
- (TOSAutoLayoutModel *)sd_resetLayout
{
    /*
     * 方案待定
    ...
    TOSAutoLayoutModel *model = [self ownLayoutModel];
    TOSAutoLayoutModel *newModel = [TOSAutoLayoutModel new];
...
- (TOSAutoLayoutModel *)sd_resetNewLayout
{
    [self sd_clearAutoLayoutSettings];
    [self sd_clearExtraAutoLayoutItems];
    return [self sd_layout];
...
- (void)sd_clearSubviewsAutoLayoutFrameCaches
{
    ...
    [self.autoLayoutModelsArray enumerateObjectsUsingBlock:^(TOSAutoLayoutModel *model, NSUInteger idx, BOOL *stop) {
...
- (void)sd_layoutSubviewsHandle{
    ...
    if (self.sd_equalWidthSubviews.count) {
        ...
        [self.sd_equalWidthSubviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger idx, BOOL *stop) {
            TOSAutoLayoutModel *model = view.sd_layout;
...
- (void)sd_resizeWithModel:(TOSAutoLayoutModel *)model
{
...
- (void)layoutAutoHeightWidthView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
...
- (void)layoutAutoWidthWidthView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if ([view isKindOfClass:[UILabel class]]) {
        UILabel *label = (UILabel *)view;
...
- (void)layoutWidthWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if (model.width) {
...
- (void)layoutHeightWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if (model.height) {
...
- (void)layoutLeftWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if (model.left) {
...
- (void)layoutRightWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if (model.right) {
...
- (void)layoutTopWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if (model.top) {
...
- (void)layoutBottomWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
    if (model.bottom) {
...
- (void)setupCornerRadiusWithView:(UIView *)view model:(TOSAutoLayoutModel *)model
{
...
@implementation UIButton (TOSAutoLayoutButton)
...
@implementation UIView (TIMChangeFrame)
...
@implementation TIMUIViewCategoryManager
