 ...
 * 用法示例：https://github.com/gsdios/TOSAutoLayout/blob/master/README.md
 *
 *********************************************************************************
...
@interface UIView (TOSAutoLayout)
...
@interface TOSAutoLayoutModelItem : NSObject
...
@property (nonatomic) CGFloat tosCF_width;
@property (nonatomic) CGFloat tosCF_height;
