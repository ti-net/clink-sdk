//
//  UITableView+TIMAutoTableViewCellHeight.h
//  TIMAutoLayout 测试 Demo
//
...
#import "UIView+TIMAutoLayout.h"

@class TIMCellAutoHeightManager;
...
@interface UITableView (TIMAutoTableViewCellHeight)

@property (nonatomic, strong) TIMCellAutoHeightManager *cellAutoHeightManager;
...
@interface UITableViewController (TIMTableViewControllerAutoCellHeight)
...
@interface NSObject (TIMAnyObjectAutoCellHeight)
...
@interface TIMCellAutoHeightManager : NSObject
