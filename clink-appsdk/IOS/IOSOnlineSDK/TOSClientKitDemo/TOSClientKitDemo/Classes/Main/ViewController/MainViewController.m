...
//    }
    ...
    TOSConnectOption * connectOption = [[TOSConnectOption alloc] initWithOption:visitorsID nickname:@"客户" headUrl:@"https://img2.baidu.com/it/u=1229468480,2938819374&fm=253&fmt=auto&app=120&f=JPEG?w=500&h=500" mobile:@"14107240003" advanceParams:@{}];
