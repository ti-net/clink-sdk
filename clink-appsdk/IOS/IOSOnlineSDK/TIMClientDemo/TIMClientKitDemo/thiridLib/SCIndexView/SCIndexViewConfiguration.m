...
+ (instancetype)configurationWithIndexViewStyle:(SCIndexViewStyle)indexViewStyle
{
    ...
    switch (indexViewStyle) {
        ...
        {
            indicatorBackgroundColor = kHexColor(0xC4CDD8); //SCGetColor(200, 200, 200, 1);
            indicatorTextColor = [UIColor whiteColor];
            indicatorTextFont = [UIFont fontWithName:kFontNameMedium size:25.f]; //[UIFont systemFontOfSize:38];
            indicatorHeight = 47.f;
        }
            break;
    ...
    return [self configurationWithIndexViewStyle:indexViewStyle
                        ...
                        indexItemBackgroundColor:[UIColor clearColor]
                              indexItemTextColor:kHexColor(0x999999) //[UIColor darkGrayColor]
                indexItemSelectedBackgroundColor:kHexColor(0x2373D9)//SCGetColor(40, 170, 40, 1)
