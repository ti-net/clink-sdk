...
5、 新增 在线客服-会话记录-查询会话详情、返回参数增加 "满意度发起方式" 字段
```

### V 2.0.74
```
1、新增 业务系统-报表-工单整体统计报表
2、新增 业务系统-报表-工单座席情况统计报表
3、新增 业务系统-报表-工单座席组情况统计报表
4、新增 业务系统-工单管理接口-关闭工单接口
5、新增 业务系统-工单管理接口-完成工单接口
```
