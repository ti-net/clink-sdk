...
```
1、数据-呼入通话记录-查询呼入通话记录列表（list_cdr_ibs），补充返回字段“查询呼入通话记录列表请求”
2、数据-呼入通话记录-查询呼入通话记录明细详情（describe_cdr_ib），补充返回字段“查询呼入通话记录列表请求”
2、数据-呼入通话记录-查询呼入通话记录明细详情（describe_cdr_ib_details），补充返回字段“查询呼入通话记录列表请求”
```