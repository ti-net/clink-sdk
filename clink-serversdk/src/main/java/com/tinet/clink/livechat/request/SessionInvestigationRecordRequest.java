 ...
 * @since 2024/12/10
 */
public class SessionInvestigationRecordRequest extends AbstractStatRequest<SessionInvestigationRecordResponse> {
    ...
    public SessionInvestigationRecordRequest() {
        super(PathEnum.RecordInvestigationsPage.value(), HttpMethodType.POST);
    }
    ...
    @Override
    public Class<SessionInvestigationRecordResponse> getResponseClass() {
        return SessionInvestigationRecordResponse.class;
    }
}
