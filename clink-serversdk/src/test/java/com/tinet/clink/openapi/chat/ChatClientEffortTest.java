...
public class ChatClientEffortTest {

    ObjectMapper mapper = new ObjectMapper();

    @Test
    public void statChatClientEffortTest() throws JsonProcessingException, ServerException, ClientException {
        // 创建API请求并设置参数
        ...
        ChatClientEffortResponse response = client.getResponseModel(request);
