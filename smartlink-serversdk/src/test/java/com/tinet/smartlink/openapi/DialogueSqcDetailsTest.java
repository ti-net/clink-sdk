...
import com.tinet.smartlink.openapi.request.sqc.DialogueSqcDetailsRequest;
 ...
 * @date 2022/8/8 16:51
 */
public class DialogueSqcDetailsTest {
    @Test
    public void test() {
        ...
        */
        ...
        // 创建API请求并设置参数
        DialogueSqcDetailsRequest request = new DialogueSqcDetailsRequest();
        request.setUniqueId("f93902e8e14f4431997dbf72fd39fbf2-1660032894.1239");
        request.setUserId("1234567");

        DialogueSqcDetailsResponse response;
        try {
            // 发起API调用并获得返回结果
