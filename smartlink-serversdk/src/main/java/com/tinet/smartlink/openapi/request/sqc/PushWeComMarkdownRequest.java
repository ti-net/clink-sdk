...
import com.tinet.smartlink.openapi.model.sqc.WeComMarkdownData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComMarkdownResponse;
 ...
 * @date 2023/3/9
 */
public class PushWeComMarkdownRequest extends BaseRequest<PushWeComMarkdownResponse> implements Serializable {
     ...
     * 消息对象
     */
    private WeComMarkdownData info;
    ...
    public WeComMarkdownData getInfo() {
        return info;
    }

    public void setInfo(WeComMarkdownData info) {
        this.info = info;
        if (info != null) {
            putBodyParameter("info", info);
        }
    }

    public PushWeComMarkdownRequest() {
        super("/sqc/wecom/pushMarkdownData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComMarkdownResponse> getResponseClass() {
        return PushWeComMarkdownResponse.class;
    }
}
