...
import com.tinet.smartlink.openapi.model.sqc.WeComTextData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComTextResponse;
 ...
 * @date 2023/3/9
 */
public class PushWeComTextRequest extends BaseRequest<PushWeComTextResponse> implements Serializable {
    ...
    public WeComTextData getText() {
        return text;
    }

    public void setText(WeComTextData text) {
        this.text = text;
        if (text != null) {
    ...
    public PushWeComTextRequest() {
        super("/sqc/wecom/pushTextData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComTextResponse> getResponseClass() {
        return PushWeComTextResponse.class;
    }
}
