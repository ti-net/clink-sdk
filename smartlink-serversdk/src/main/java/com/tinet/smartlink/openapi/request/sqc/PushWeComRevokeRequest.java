...
import com.tinet.smartlink.openapi.model.sqc.WeComRevokeData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComRevokeResponse;
 ...
 * @date 2023/3/9
 */
public class PushWeComRevokeRequest extends BaseRequest<PushWeComRevokeResponse> implements Serializable {
     ...
     * 消息对象
     */
    private WeComRevokeData revoke;
    ...
    public WeComRevokeData getRevoke() {
        return revoke;
    }

    public void setRevoke(WeComRevokeData revoke) {
        this.revoke = revoke;
        if (revoke != null) {
    ...
    public PushWeComRevokeRequest() {
        super("/sqc/wecom/pushRevokeData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComRevokeResponse> getResponseClass() {
        return PushWeComRevokeResponse.class;
    }
}
