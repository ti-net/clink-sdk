...
import com.tinet.smartlink.openapi.model.sqc.WeComMixedData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComMixedResponse;
 ...
 * @date 2023/3/9
 */
public class PushWeComMixedRequest extends BaseRequest<PushWeComMixedResponse> implements Serializable {
    ...
    public WeComMixedData getMixed() {
        return mixed;
    }

    public void setMixed(WeComMixedData mixed) {
        this.mixed = mixed;
        if (mixed != null) {
            putBodyParameter("mixed", mixed);
        }
    }

    public PushWeComMixedRequest() {
        super("/sqc/wecom/pushMixedData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComMixedResponse> getResponseClass() {
        return PushWeComMixedResponse.class;
    }
}
