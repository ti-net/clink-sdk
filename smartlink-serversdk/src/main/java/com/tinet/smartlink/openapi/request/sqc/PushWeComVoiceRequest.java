...
import com.tinet.smartlink.openapi.model.sqc.WeComVoiceData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComVoiceResponse;
 ...
 * 推送企微语音消息请求实体
 */
public class PushWeComVoiceRequest extends BaseRequest<PushWeComVoiceResponse> implements Serializable {
    ...
    public WeComVoiceData getVoice() {
        return voice;
    }

    public void setVoice(WeComVoiceData voice) {
        this.voice = voice;
        if (voice != null) {
    ...
    public PushWeComVoiceRequest() {
        super("/sqc/wecom/pushVoiceData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComVoiceResponse> getResponseClass() {
        return PushWeComVoiceResponse.class;
    }
}
