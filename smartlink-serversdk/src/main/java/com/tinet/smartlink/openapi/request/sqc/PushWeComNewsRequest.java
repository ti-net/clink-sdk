...
import com.tinet.smartlink.openapi.model.sqc.WeComNewsData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComNewsResponse;
 ...
 * @date 2023/3/9
 */
public class PushWeComNewsRequest extends BaseRequest<PushWeComNewsResponse> implements Serializable {
    ...
    public WeComNewsData getInfo() {
        return info;
    }

    public void setInfo(WeComNewsData info) {
        this.info = info;
        if (info != null) {
    ...
    public PushWeComNewsRequest() {
        super("/sqc/wecom/pushNewsData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComNewsResponse> getResponseClass() {
        return PushWeComNewsResponse.class;
    }
}
