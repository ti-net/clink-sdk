...
import com.tinet.smartlink.openapi.model.sqc.WeComEmotionData;
import com.tinet.smartlink.openapi.response.sqc.PushWeComEmotionResponse;
 ...
 * @date 2023/3/9
 */
public class PushWeComEmotionRequest extends BaseRequest<PushWeComEmotionResponse> implements Serializable {
     ...
     * 消息对象
     */
    private WeComEmotionData emotion;
    ...
    public WeComEmotionData getEmotion() {
        return emotion;
    }

    public void setEmotion(WeComEmotionData emotion) {
        this.emotion = emotion;
        if (emotion != null) {
            putBodyParameter("emotion", emotion);
        }
    }

    public PushWeComEmotionRequest() {
        super("/sqc/wecom/pushEmotionData", HttpMethodType.POST);
    }

    @Override
    public Class<PushWeComEmotionResponse> getResponseClass() {
        return PushWeComEmotionResponse.class;
    }
}
